...
const Card = ({category, description, id, image, price, title, handleAdd}) => {
    ...
    return(
        <>
            <div className="card w-96 shadow-xl bg-white justify-between">
            <Link to={id.toString()} >
            <figure>
                <img src={image} alt={title} className="w-full rounded-lg hover:scale-95 transition-all"/>
            </figure>
            </Link>
            ...
            <div className="p-5">
                ...
                <p className="text-lg italic text-black">${price}</p>
                    ...
                    className="bg-black text-white p-5 mt-5 rounded-md hover:bg-black/80 transition-all">Buy now</button>
